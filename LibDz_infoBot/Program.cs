...
internal class Program
{
    ...
    private static async Task Main()
    {
        ...
        string connectionString = ConfigurationManager.ConnectionStrings["TelegramBotLibDB"].ConnectionString;//создание соединения с базой (для использования во всём коде)
